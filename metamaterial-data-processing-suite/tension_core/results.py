...
def build_tension_result_row(
    *,
    ...
    return [
        ...
        fracture_strength / 1e6 if _is_present(fracture_strength) else np.nan,
...
def write_tension_results(output_path: Path, rows):
...
def save_results_to_xlsx(
    ...
    *,
    ...
    row_values = build_tension_result_row(
